...
export default function CliffhangerEnding() {
  ...
  return (
    <div
      ...
      className="w-full min-h-full flex flex-col items-center justify-start py-10 px-4 select-none relative z-10 animate-fade-in font-mono box-border"
    >
      <div className="w-full max-w-5xl flex flex-col items-center gap-6">
        ...
        <div className="w-full bg-black/90 border border-white/20 rounded-2xl p-5 shadow-2xl backdrop-blur-md relative overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-3 text-xs text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-bold tracking-wider">RECOVERED SIGNAL // AIR-GAPPED SSD INTERCEPT</span>
            </div>
            <span className="text-emerald-400 font-bold">2/2 CODES DECRYPTED</span>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-white/10 flex justify-between items-center text-xs text-slate-400">
            <span className="text-cyan-300 italic">{cliffhanger.marrowSignature}</span>
        ...
        <div className="w-full bg-gradient-to-b from-white/10 via-black to-black border-2 border-white/30 rounded-3xl p-6 sm:p-7 shadow-[0_0_50px_rgba(255,255,255,0.15)] flex flex-col gap-5 relative overflow-hidden mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
            ...
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-slate-200 text-black font-extrabold text-sm uppercase tracking-wider rounded-2xl transition-all shadow-[0_0_30px_rgba(255,255,255,0.35)] flex items-center justify-center gap-2 group cursor-pointer shrink-0"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="p-3 bg-black/60 border border-white/10 rounded-xl flex items-center gap-3">
              ...
              <div>
                <div className="text-[10px] text-slate-400 uppercase">Rewards</div>
                <div className="text-xs font-bold text-white">Cash Prizes & Certs</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-white/10 text-xs">
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-black hover:bg-white/15 border border-white/20 text-slate-200 rounded-xl flex items-center gap-1.5 cursor-pointer transition-all"
              >
