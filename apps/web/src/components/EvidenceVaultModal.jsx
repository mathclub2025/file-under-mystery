...
const LEVEL_LIST = [
  { id: "level1", title: "Evidence Item #01: The Photograph", basePoints: 10 },
  { id: "level2", title: "Evidence Item #02: The Voicemail", basePoints: 12 },
  { id: "level3", title: "Evidence Item #03: The Recording", basePoints: 14 },
  { id: "level4", title: "Evidence Item #04: The Holiday Photo", basePoints: 16 },
  { id: "level5", title: "Evidence Item #05: The Cipher Machine", basePoints: 18 },
  { id: "level6", title: "Evidence Item #06: Network Protocol Capture", basePoints: 15 },
  { id: "level7", title: "Evidence Item #07: The Corrupted Document", basePoints: 18 },
  { id: "level8", title: "Evidence Item #08: The Harmonic Signal", basePoints: 20 },
  { id: "level9", title: "Evidence Item #09: Celestial Astrometry", basePoints: 22 },
  { id: "level10", title: "Evidence Item #10: Cellular Automata", basePoints: 22 },
  { id: "level11", title: "Evidence Item #11: Differential Audio", basePoints: 24 },
  { id: "level12", title: "Evidence Item #12: Campus Topology Graph", basePoints: 25 },
  { id: "final", title: "Phase IV: Meta-Assembly Hardware Boot", basePoints: 40 }
];
          ...
          {LEVEL_LIST.map((lvl, idx) => {
            ...
            return (
              ...
              >
                    ...
                    {hasFindings ? (
                      <>
                        <span className={`px-2.5 py-1 text-[10px] font-mono font-bold rounded-xl uppercase tracking-widest flex items-center gap-1.5 shadow-sm ${
                          ...
                          TOKEN: {solvedTokens?.[lvl.id] || (isSolved ? "VERIFIED" : "RECOVERED")}
                        </span>
                ...
                {hasFindings ? (
                  <div className="mt-3 p-3.5 bg-black/60 rounded-xl border border-white/10 text-xs text-slate-300 leading-relaxed flex flex-col gap-1.5">
                    ...
                    <p className="italic text-slate-200 font-sans text-xs">
                      "{typeof memo === "string" ? memo : memo?.notebookFragment || memo?.memo || memo?.solutionExplanation || "Evidence fragment logged into blackbox telemetry."}"
                    </p>
                  </div>
                ) : (
